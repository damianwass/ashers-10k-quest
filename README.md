...
- No default selected status for workouts
- Button order is Complete / Incomplete / Skipped
- Incomplete opens a partial-run form asking miles completed and what happened
- Incomplete runs log actual miles completed and show a supportive message
